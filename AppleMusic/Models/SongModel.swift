...
public struct SongModel: Codable {
    ...
    public init(artistName: String?, id: String?, releaseDate: String?, name: String?, collectionName: String?, kind: String?, copyright: String?, artistId: String?, contentAdvisoryRating: String?, artistUrl: String?, artworkUrl100: String?, genres: [GenreModel]?, url: String?) {
